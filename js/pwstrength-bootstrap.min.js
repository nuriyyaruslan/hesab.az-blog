    ...
    (function ($, ui) {
        ...
        ui.updateProgressBar = function (options, $el, cssClass, percentage) {
            ...
            if (options.ui.bootstrap4) {
                ...
                $(".meter-text").css("color", "#e53935").text("");
            }
        ...
        ui.percentage = function (options, score, maximun) {
            ...
            if(score <= 0){
                result = 25;
                $(".meter-text").css("color", "#e53935");
                $(".meter-text").text("Password strength: " + "Weak");
                className = "pb-weak";
            }
            else if(score > -2000 && score <= 25){
                result = 25;
                $(".meter-text").css("color", "#e53935");
                $(".meter-text").text("Password strength: " + "Weak");
                className = "pb-weak";
                ...
                result = 50;
                $(".meter-text").css("color", "#fdd835");
                $(".meter-text").text("Password strength: " + "Normal");
                className = "pb-normal";
            }else if(score >50 && score <= 75 ){
                result = 75;
                $(".meter-text").css("color", "#81c784");
                $(".meter-text").text("Password strength: " + "Strong");
                className = "pb-strong";
            }else if(score > 75 && score <= 2000){
                result = 100;
                $(".meter-text").css("color", "#43a047");
                $(".meter-text").text("Password strength: " + "Very Strong");
                className = "pb-very-strong";
            }
            $(".pwstrength_viewport_progress .progress .progress-bar").removeClass("pb-weak").removeClass("pb-normal").removeClass("pb-strong").removeClass("pb-very-strong");
            $(".pwstrength_viewport_progress .progress .progress-bar").addClass(className);
